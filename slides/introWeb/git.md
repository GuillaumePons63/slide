...
![bg right h:400px](/slides/introWeb/images/motivation1.png)

--

## 2. Problème

![bg right h:600px](/slides/introWeb/images/lineofcomm.jpg)
...
![bg right h:400px](/slides/introWeb/images/motivation2.png)
...
- Travail dans un _repository_ (dépôt en français) == un dossier
...
## 8. Importance des messages

![bg right w:100%](/slides/introWeb/images/git_commit.png)

---

## 9. Précisions techniques
...
![](/slides/introWeb/images/branches.png)
...
![bg right w:110%](.//slides/introWeb/images/push-pull.png)

---

## 4. Le vocabulaire des serveurs distants pour Git

- _Remote_ : Serveur distant permettant la synchronisation manuelle de votre dépôt
- _origin_ : Nom du serveur principal, un peu comme master est la branche principale. Pour l'instant, nos serveurs n'en ont pas
- _push_ : Envoyez les modifications effectuées sur un serveur donné.
- _pull_ : Retrouvez les informations depuis un serveur donné
- _clone_ : Copie sur votre PC d'un dépôt trouvé en ligne
- _fork_ : dérivé d'un dépôt d'un-e autre développeur-se
- _upstream_ : Par convention, nom d'un second serveur, généralement le serveur source du _fork_
...
![bg right w:100%](/slides/introWeb/images/ehri-issues.png)

---

## 6. Github : les issues d'un repo data

![bg right w:100%](/slides/introWeb/images/canonicallatinlit-issues.png)

---

## 7. Github : un exemple de bonne issue

![bg right w:100%](/slides/introWeb/images/oglfirst1k-issue1548.png)

---

## 8. Github : un exemple de mauvaise issue

![bg right w:100%](/slides/introWeb/images/canonicallatinlit-issue86.png)
...
## 10. Collaborer : les _pull requests_

- Une _pull request_ (Vocabulaire de _github_) est une demande d'autorisation de contribution à un dépôt.
...
## 11. Collaborer : les _pull requests_ (Histoire exemple)
...
- Les _Pulls requests_ règlent le problème du code qui passe inaperçu ou
...
![bg right width:100%](/slides/introWeb/images/ci.jpg)
...
![D'après http://agiledata.org/essays/tdd.html](/slides/introWeb/images/tdd.png)
...
![https://www.commitstrip.com/fr/2014/05/07/the-truth-behind-open-source-apps/](/slides/introWeb/images/Strip-Vision-Open-source-650-final1.jpg)
...
![https://xkcd.com/1695/](/slides/introWeb/images/code_quality_2.png)
...
![http://www.commitstrip.com/fr/2016/07/27/documentation-just-before-vacation/](/slides/introWeb/images/Strip-Commentaires-davant-vacances-650-final-2.jpg)
...
- [_Ignoring Files_, Github](https://help.github.com/articles/ignoring-files/)
